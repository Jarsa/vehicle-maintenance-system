...
//                     .filter([
//                         ["responsible_id", "=", self.mechanic_id],
//                         ["state", "=", "process"],
//                     ])
//                     .limit(1)
//                     .all()
//                     .then(function (current_activity) {
...
//             this.$el.html(
//                 QWeb.render("VmsKioskTaskHandler", {
//                     activity: this.activity_selected,
...
//                 .call(method, [this.activity_selected.id])
//                 .then(function (state) {
...
//             var total_seconds =
//                 Math.round(Math.abs(this.activity_process_time - new Date()) / 1000) +
//                 this.total_time;
...
//             var self = this;
//             activity_time_model
//                 .query(["start_date", "end_date", "state"])
...
//                         self.activity_process_time = moment(
//                             current_activity.start_date + " 0000",
//                             "YYYY-MM-DD HH:mm:ss ZZ"
//                         ).toDate();

//                         $.when(self.get_total_time(times)).done(function (total_time) {
//                             self.total_time = total_time;
//                             self.clock_start = setInterval(function () {
//                                 self.$(".o_vms_kiosk_clock").text(
...
//             var homeparentid =
//                 (((e || {}).target || {}).parentElement || {}).id === "return_home";
...
//                     var message = _t(
//                         "Inactivity was detected, the session will be closed in 5 seconds."
//                     );
//                     var notice = $(
//                         '<div class="vms-alert alert-warning">\
...
//                 this.inactivity = setTimeout(function () {
//                     self.go_home();
//                 }, 20000);
//             }
//         },
