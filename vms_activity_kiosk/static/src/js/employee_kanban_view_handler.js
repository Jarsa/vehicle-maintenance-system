...
//                 if (
//                     sup.el.classList.value.includes(
//                         "o_hr_employee_vms_activity_kiosk_kanban"
//                     )
//                 ) {
//                     sup.getParent()
//                         .getParent()
//                         .getParent()
//                         .$el.find("div.o_main_navbar")
//                         .remove();
//                 }
//             });
//         },
...
//                 this.$el.parents(".o_hr_employee_vms_activity_kiosk_kanban").length
//             ) {
